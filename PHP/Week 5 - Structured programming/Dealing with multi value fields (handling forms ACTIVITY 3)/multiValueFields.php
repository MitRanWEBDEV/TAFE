...
<body>
    <form action="processRegistration.php" method="post">
        <fieldset>
            ...
            <div>
                <label for="course">Select which course(s) you have completed</label>
            ...
            <div><label for="specials">Do you want to receive our specials?</label>
            <input type="checkbox" name="newsletter[]" id="specials" value="specials">
            </div>
            ...
            <div>
                <button type="submit" name="submitButton" id="submitButton">Send Details
                </button>
            </div>
        </fieldset>
    </form>
